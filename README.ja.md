...
> ⚠️ 上記の警告は、アプリに有償の署名証明書を付けていないために表示されるものです。表示が不安な場合は、[CONTRIBUTING.ja.md](CONTRIBUTING.ja.md) の手順で自分でビルドすることもできます。
...
プルリクエストも歓迎します 🙌 開発に参加する場合は [CONTRIBUTING.ja.md](CONTRIBUTING.ja.md) を参照してください。
